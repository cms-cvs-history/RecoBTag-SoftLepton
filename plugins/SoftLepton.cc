...
SoftLepton::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  {
    edm::Handle<reco::ElectronCollection> h_electrons;
  ...
  {
    edm::Handle<reco::PixelMatchElectronCollection> h_electrons;
    iEvent.get(leptons_id, h_electrons);
  ...
  {
    edm::Handle<reco::GsfElectronCollection> h_electrons;
    iEvent.get(leptons_id, h_electrons);
